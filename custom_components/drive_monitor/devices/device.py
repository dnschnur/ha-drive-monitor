...
class DeviceSensor(SensorEntity, DeviceEntity):
  ...
  def __init__(self,
    ...
    Args:
      ...
      suggested_unit_of_measurement: Initial display units. E.g. for a sensor
          whose unit of measurement is 'B' (bytes), the suggested unit might be
          'GB' (gigabytes) to make the values shown in the UI readable.
      suggested_display_precision: Initial number of decimal places to display.
